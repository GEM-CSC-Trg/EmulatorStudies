...
static constexpr auto s_tag = "[TriggerPrimitiveReader]";

TEST_CASE("Standard checks of TriggerPrimitiveReader", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("TriggerPrimitiveReader"
